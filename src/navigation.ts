  ...
  links: [
    ...
    },
    {
      ...
      links: [
        ...
        { text: 'Composting Microbiome Lab', href: getPermalink('/projects/compost-microbiome-lab') },
        ...
        { text: 'Undergraduate Software Engineering', href: getPermalink('/projects/undergraduate-software-engineering') },
      ],
    },
    {
